...
#定义变量
#授权文件自动生成url
APX= https://github.com/liehuolianyu/test/raw/master/apx1.php
#安装包下载地址
INSTALLPACK= https://github.com/liehuolianyu/test/raw/master/91yunserverspeeder.tar.gz
#判断版本支持情况的地址
CHECKSYSTEM= https://github.com/liehuolianyu/test/raw/master/serverspeederbin.txt
#bin下载地址
...
#下载安装包
wget -N --no-check-certificate -O $INSTALLPACK 
